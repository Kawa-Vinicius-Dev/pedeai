...
| `order_item_option` | `store_id`, `order_item_id`, `option_item_id`, `group_name`, `name`, `code`, `quantity`, `unit_price_cents`, `total_cents` | Snapshot. |
